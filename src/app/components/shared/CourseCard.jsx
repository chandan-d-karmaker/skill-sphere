...
const CourseCard = ({ course }) => {
    return (
        <div className="card bg-base-100 shadow-sm border-2 border-red-50 transition-all duration-300 hover:shadow-[8px_8px_0px_0px_#555] hover:-translate-y-1 hover:-translate-x-1">
